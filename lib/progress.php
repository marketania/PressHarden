...
final class PressHardenProgress {
    private $tty = null;
    private $total = 0;
    private $width = 79;
    private $last = 0.0;
    ...
    public function __construct($label) {
        $this->label = $label;
        if (getenv('PH_PROGRESS_ACTIVE') !== '1' || !function_exists('stream_isatty')) return;
