...
This repository uses GPT-6 as a **development workflow default**. The PressHarden application itself does not require OpenAI, an API key, or network access to OpenAI at runtime.
