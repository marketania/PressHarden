...
putenv('PH_PROGRESS_ACTIVE=0');
ob_start();
$p = new PressHardenProgress('PHP');
...
if (!function_exists('stream_isatty') || !@stream_isatty(STDIN)) {
    putenv('PH_PROGRESS_ACTIVE=1'); putenv('PH_PROGRESS_TOTAL=20');
    $p = new PressHardenProgress('JavaScript'); $p->advance(5, true); $p->finish(5, 1);
}
